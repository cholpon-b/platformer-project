...
inline const size_t VICTORY_BALL_COUNT     = 1000;
inline const float VICTORY_BALL_MAX_SPEED  = 3.0f;
inline const float VICTORY_BALL_MIN_RADIUS = 4.0f;
inline const float VICTORY_BALL_MAX_RADIUS = 6.0f;
inline const Color VICTORY_BALL_COLOR      = { 10, 80, 180, 255 };
